...
use crate::server_versions::{
    ...
    MIN_SERVER_VER_CUSTOMER_ACCOUNT, MIN_SERVER_VER_D_PEG_ORDERS, MIN_SERVER_VER_DECISION_MAKER,
    MIN_SERVER_VER_DELTA_NEUTRAL, MIN_SERVER_VER_DELTA_NEUTRAL_CONID,
    MIN_SERVER_VER_DELTA_NEUTRAL_OPEN_CLOSE, MIN_SERVER_VER_DURATION,
    MIN_SERVER_VER_EXECUTION_DATA_CHAIN, MIN_SERVER_VER_EXT_OPERATOR,
...
impl EncodableRequest for ContractDetailsRequest {
    ...
    fn encode_fields_for_server_version(
        ...
        // reqContractDetails remains a versioned legacy request even on
        // current TWS/Gateway servers. Omitting version 8 shifts req_id and
        // makes the symbol get decoded as Con Id.
        fields.push(8)?;
        fields.push(self.req_id)?;
